...
public class TestLeadAssignment2Case3DuplicateLead {
	...
	public static void main(String[] args) {
        ...
        driver.findElement(By.xpath("//input[@name='emailAddress']")).sendKeys("angshumaan19@gmail.com");
        driver.findElement(By.xpath("//button[text()='Find Leads']")).click();
        // not able to understand rest of the steps in assignment//
